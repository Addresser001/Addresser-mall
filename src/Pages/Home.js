        ...
        <div className="homeContainer">
            ...
            <section className="Design-section">
                <div className="Design-text">
                    ...
                    <div className="Show-Now-Btn-container">
